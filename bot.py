...
TOKEN = '7486893779:AAE8jq5XIW3HWhTkYDiq5_Lnin_B7R-68Ig'
app = Client("remymbot",
  api_id=23452838, api_hash="48333ea197122c79561e1321a0687076",
  bot_token=TOKEN, 
)
...
@app.on_message(filters.command("abmn") & filters.private)
